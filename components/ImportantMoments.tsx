...
export function ImportantMoments({ moments }: ImportantMomentsProps) {
  ...
  return (
    <div className="space-y-4 border-l-2 border-united-red/25 pl-5">
      {moments.map((moment) => (
        <article
        ...
        >
          ...
          <p className="text-sm font-bold uppercase tracking-[0.16em] text-united-red">
            {moment.month}
          </p>
          <h3 className="mt-2 text-xl font-black text-united-black">
            {moment.title}
          </h3>
